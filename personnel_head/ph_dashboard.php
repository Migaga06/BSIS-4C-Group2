...
$pending_query = "SELECT COUNT(*) AS total_pending FROM leave_requests WHERE status='Approved by Personnel'";
$approved_query = "SELECT COUNT(*) AS total_approved FROM leave_requests WHERE approved_head='Yes'";
$rejected_query = "SELECT COUNT(*) AS total_rejected FROM leave_requests WHERE status='Rejected by Personnel Head'";
