...
if ($_SESSION['role'] != 'Personnel Head') {
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $status = $action == 'approve' ? 'Approved by Personnel Head' : 'Rejected by Personnel Head';
    $approved_head = $action == 'approve' ? 'Yes' : 'No';
    $query = "UPDATE leave_requests SET status='$status', approved_head='$approved_head', rejection_remarks='$rejection_remarks' WHERE id='$leave_id'";
    if (mysqli_query($conn, $query)) {
        $_SESSION['toast_success'] = "Leave request updated successfully.";
        header('Location: ph_pending_applications.php');
        exit();
    } else {
...
$query = "SELECT * FROM leave_requests WHERE status='Approved by Personnel'";
...
<html>
<head>
    <title>Personnel Head Dashboard</title>
...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <!-- Sidebar -->
        <?php include '../includes/ph_sidebar.php'; ?>

        <!-- /#sidebar-wrapper -->

        <!-- Page Content -->
        <div class="content" id="page-content-wrapper">
        <?php include '../includes/ph_navbar.php'; ?>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="ph_view_leave.php?id=<?= htmlspecialchars($row['id']) ?>">View</a>
