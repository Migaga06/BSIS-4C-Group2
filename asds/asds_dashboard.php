...
$pending_query = "SELECT COUNT(*) AS total_pending FROM leave_requests WHERE status='Approved by Personnel Head'";
$approved_query = "SELECT COUNT(*) AS total_approved FROM leave_requests WHERE approved_asds='Yes'";
$rejected_query = "SELECT COUNT(*) AS total_rejected FROM leave_requests WHERE status='Rejected by ASDS'";
