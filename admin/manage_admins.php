...
// Fetch all admins, personnel, personnel head, and ASDS, organized by last name from A-Z
$query = "SELECT user_id, lastname, firstname, district_section, role FROM users WHERE role IN ('Admin', 'Personnel', 'Personnel Head', 'ASDS')";
...
$district_query = "SELECT DISTINCT district_section FROM users WHERE role IN ('Admin', 'Personnel', 'Personnel Head', 'ASDS') ORDER BY district_section ASC";
        ...
        <div class="content" id="page-content-wrapper">
            ...
            <div class="container-fluid mt-2">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h2 class="Form-Head">Manage Admins</h2>
